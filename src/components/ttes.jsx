...
const Approvers = () => {
  ...
  const staticData = [
    { id: 1, user_id: 'User1', branch_id: 'Branch1', doc_type_id: 'Type1', status: 'Active' },
    { id: 2, user_id: 'User2', branch_id: 'Branch2', doc_type_id: 'Type2', status: 'Inactive' },
    { id: 3, user_id: 'User3', branch_id: 'Branch3', doc_type_id: 'Type3', status: 'Active' },
  ];
  ...
  const handleOpen = (row, type) => {
    ...
    if(type === "add") {
      ...
      if(row.parameter === "APPROVERS"){
        ...
        fetchApprovers(codeTypeMapping[row.parameter]);
      setModalType(type);
    }else if(type === "update"){
          ...
          >
            ...
            >
              <ModalClose variant="plain" sx={{ m: 1 }} />
               ...
               {/* create a table to display static data */}
               <OrderTable />
